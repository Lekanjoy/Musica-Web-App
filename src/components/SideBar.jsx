...
function SideBar() {
  return (
    <nav className="bg-bgDarkSecondary border border-t-inputText border-x-0 border-b-0 fixed z-50  w-64  h-auto rounded-br-2xl mt-[64px] transition-all left-0 pl-9 py-16 ">
      <Link to="/">
