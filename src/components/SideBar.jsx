...
function SideBar() {
  ...
  return (
    <nav className="bg-bgDarkSecondary w-80 h-auto rounded-xl mt-[85px] transition-all pl-9 py-16 ">
      ...
      <Link to="/my collections">
          <div className="flex items-center  gap-x-7 mb-12  font-bold cursor-pointer">
            ...
            <p className="ml-[5px] text-textSideMenu text-[17px] ">My Collections</p>
          </div>
      </Link>
